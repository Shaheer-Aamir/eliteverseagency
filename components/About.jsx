    ...
    <div id="about" className="w-full flex flex-col items-center justify-center pt-20 pb-20 md:pb-52 font-poppins bg-bgblue relative">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          ></div>
          {/* Modal Content */}
          <div className="bg-darkblue text-center rounded-2xl p-6 max-h-[90vh] z-10 max-w-[800px] w-full font-raleway flex flex-col gap-4 animate__animated animate__fadeInDown animate-delay-1s">
